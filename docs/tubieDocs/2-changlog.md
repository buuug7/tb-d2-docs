...
- 修复亚瑞特山脉之巅复活怪物也会开门的问题
- 取消之前设置的亚瑞特山脉之巅 9 层开门的概率降低 3 个百分点

## 2025/06/28

- 单体暴风雪技能关联加成技能跟暴风雪保持一致
- 降低疯牛释放闪电概率
- 野蛮人 WC 挂载武器伤害, WC PLUS 取消挂载武器伤害
- 取消史诗亚瑞特的面容的 WC PLUS, 更换为被击中时有 80% 的概率施展等级 20 单体暴风雪
- 史诗深度死亡被击中时有 80% 的概率施展等级 5 单体暴风雪修改为 等级 10 单体暴风雪
- 法师冰封球修改为多重慢速冰封球, 将冰封球速度放慢，距离拉长，以增加冰法的可玩性
- 亚瑞特山脉之巅 9 层以后开门的概率降低 3 个百分点
...
- 修改背包坐标数据错误导致快速存取失效的问题
- 死灵重生技能复活怪物持续时间随着技能增加
- 野蛮人 WC PLUS 技能增强, 有 BUG 会卡死游戏, 虽然强大但慎用
- 普通模式注入,打孔界面背包显示不全问题修改(沈伦魔)
...
> 感谢 **沈伦魔** 的帮助, 没有它的帮助我无法完成这次更新

- 人物背包从 `12 x 10` 增加到 `12 x 12`, 增加了 24 个格子
- 上次更新的大背包对普通模式没法支持, 这次终于可以支持了, 可以通过 `3_普通模式启动.bat` 启动, 或者自己创建 `D2Loader-high.exe` 的快捷方式启动

## 2025/06/03

- 感谢沈伦魔提供的资源, 背包从 11x8 增加到 12x10, 增加了 32 个格子
- 感谢沈伦魔提供的插件, 客户端现在使用沈伦魔提供的 `D2Loader.exe`, 想使用普通模式请使用 `4_普通模式启动.bat` 启动游戏
- 因为对大背包的支持不好, 客户端删除了 `D2Loader-high.exe` 加载器

## 2025/05/15

- 感谢无名氏, 法师闪电修改为多重攻击, 数量 2 + lv / 12

## 2025/05/07

- 感谢 INT3 的帮助, 修改了通用附魔的一个严重 BUG
- 物品袋子支持洗灵光法珠
...
- 为了避免跟通用附魔冲突, 物品附魔溅射公式修改为 武器 + 灵魂宝石 + 28#
- 通用附魔, 取消随机 1 孔 属性
- 注意: 请先附魔地材后在做符文之语, 不要直接用做好的符文之语附魔会导致物品消失
...
- 修改多重骨矛，只有中间一根有伤害, 其他的都没伤害的问题
- 支持更多史诗物品回收

## 2025/03/22

- 新增 阿凯尼的荣耀 Arkaine's Valor【史诗】,99+ 场景掉落
- 新增 暴风尖塔 Stormspire【史诗】,99+ 场景掉落
- 新增 吸血鬼的凝视 Vampire Gaze【史诗】,94+ 场景掉落
- 新增 末日毁灭者 Doombringer【史诗】,94+ 场景掉落
- 所有史诗增加特殊附魔, 限制附魔一次
  - 附魔公式: 史诗暗金 + 普通暗金 + 1 灵魂宝石 + 30#
  - 附魔属性: +2 职业技能, +2 单体技能(有可能为空)

## 2025/03/14

- 关底 BOSS 死亡后 25% 概率复活, 复活的 BOSS 死亡同样有 25% 概率复活, 可通过特殊物品增加复活概率至 75%
- 成长护身符死亡经验惩罚比例从 2% 调整到 1%
- 信念范围调整, 默认为 20(13.3 码), 范围调整为随着等级增加范围增大, 最大可到 40(26.6 码)
- 崔斯特牛场高级物品爆率增加
- 技能书爆率略微增加
- 单系红门(元素门)爆率略微增加
- 更新背包护身符区域样式
- 蓝色超大型护身符第一次,第二次附魔所需符文从 30#, 31# 调整为 29#, 30#
