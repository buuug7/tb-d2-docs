...
- [x] 双倍掉落护身符现在更名为多倍掉落护身符,只能佩戴一件
- [x] 移除圣神拉速项链上的 fullsetgeneric 特效
- [x] 符文之语疯狂增加新属性 **15% 概率触发 25 级暗黑破坏神大火圈** 技能, 删除 TP 技能属性
...
- [x] 客户端高清字体更换
- [ ] 符文可以合成山顶门票跟元素门票,但是代价要高于自己刷门票,不然没人去打门票
- [ ] 刺客和蛮子。还是工具人。让大家想办法吧
- [ ] 符文合关底直达
- [ ] 在搞个新地图 就是 A2 A3 A4 A5 的怪 地图,可以靠用牛场地图,但是删除牛场地图中围栏
...
- [ ] 把元素门改了，统一设置 10 张到 15 张地图，每 5 级信念一张图，信念和伤害够，啥系都能打，每高级一级，，增加掉落牛逼物品。
