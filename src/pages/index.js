        ...
        <section className="container my-4">
          <div className={styles.row1}>
            <div className={styles.row1Left}>
              <h1>自定义红门</h1>
              <p>
                我们新增了普通红门，包括火门，电门，冰门，毒门，魔门，肉门，场景等级为100等级。
                除了普通红门，还引入了105等级场景的高级红门，亚瑞特山脉之巅为爬塔模式，1
                层门票巴尔出, 暗黑破坏神出, 2
                层以上通过杀死怪物随机出现红门进入, 怪物难度逐层增加,
          ...
          <div className={styles.row1}>
            ...
            <div className={styles.row1Left}>
              <h1>技能调整</h1>
              <p>
                我们对法师的闪电系，冰冷系，火焰系做了适当的增强，比如连锁闪电，新星，雷雨风暴等技能的施法范围做了适当增大，
                对冰冷系霜之星星，冰封球等技能的延迟进行了缩短，还新增了几种自定义技能，
                比如暗黑破坏神的大火圈技能，赋予给部分史诗暗金跟部分符文之语以CTC方式触发
              </p>
            </div>
          </div>
          ...
          <div className={styles.row1}>
            <div className={styles.row1Left}>
              <h1>多倍怪物场景</h1>
              <p>
                普通难度怪物数量 2 倍,邪恶洞窟,可快速升级到 50
                级，噩梦难度怪物数量 3 倍，地狱难度怪物数量 5 倍,
                其中牛场怪物数量为 8 倍
              </p>
            </div>
            <div className={styles.row1Right}>
          ...
          <div className={styles.row1}>
            <div className={styles.row1Left}>
              <h1>史诗暗金</h1>
              <p>
                史诗暗金是对原版暗金的增强, 掉落后属性跟原版暗金一致,
                所有变量都是 MAX, 插槽通常为 1-MAX 孔, 可以通过附魔的方式增强它,
                大多数史诗暗金只在 99+ 场景掉落, 少部分在 95+ 场景掉落.
                史诗暗金一般附魔次数限定在 20 次, 史诗暗金物品 + 原版暗金物品 +
                26# = 强化后的史诗暗金(可附魔多次).
              </p>
            </div>
            <div className={styles.row1Right}>
